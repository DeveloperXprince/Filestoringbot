...
class Config(object):
	...
	ABOUT_BOT_TEXT = f"""
This is  Prince and i am Permanent FileStoring Bot. 
Send Me any Media or File.I can Work In Channel too Add Me to Channel with Edit Permission, I will add save Uploaded File in Channel and Share a Shareable Link. 

╭────[ **🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅**]────⍟
│
├🔸🤖 **My Name:** [Prince ✨i](https://t.me/{BOT_USERNAME})
│
...
│
├🔸👨‍💻 **Developer:** [@detective_prince](https://t.me/detective_prince) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/Altronchats)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](AltronChats)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@detective_prince](https://t.me/detective_prince) 
...
[**Donate Me**](t.me/detective_prince) (contact him ✨)
"""
	HOME_TEXT = """
Hello [{}](tg://user?id={})\n\n 
